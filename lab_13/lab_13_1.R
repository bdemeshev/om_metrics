...
set.seed(777)
boot_medians = boot(speed, get_boot_median, R = 10000)
boot_medians
boot_medians$t
...
set.seed(777)
boot_medians = boot(speed, get_boot_median2, R = 10000)
boot_medians
boot_medians$t
...
get_boot_median3 = function(vector, indices) {
  ...
  boot_median_var = var(boot_boot$t)
  return(c(boot_median, boot_median_var))
}

set.seed(777)
boot_medians = boot(speed, get_boot_median3, R = 1000)
boot_medians
boot_medians$t

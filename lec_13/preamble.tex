...
\addtobeamertemplate{frametitle}{\hspace*{-0.05 cm}}{\vspace*{0.25cm}}
...
%\setbeamertemplate{footline}[page number] % это переключатель для номеров слайдов! откомментируем-закомментируем
